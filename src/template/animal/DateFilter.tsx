...
const DateFilter = () => {
  ...
  return (
    <div className='border-t border-gray-200 px-4 py-4 grid-cols-9 grid'>
      <div className='col-start-1 col-end-5'>
        <label className='block text-sm mb-2 font-medium text-gray-700 lg:text-xs lg:mb-1'>
          시작일
        </label>
        <CusDatePicker
      ...
      <div>
        <div className='h-5 mt-2 lg:h-3'></div>

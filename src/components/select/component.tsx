...
export const SelectScrollUpButton = ({ className, ref, ...props }: ISelectScrollUpButtonProps) => (
...
export const SelectLabel = ({ className, ref, ...props }: ISelectLabelProps) => (
...
export const SelectSeparator = ({ className, ref, ...props }: ISelectSeparatorProps) => (

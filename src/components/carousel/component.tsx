...
import type {
  ICarouselApi,
  ICarouselContextProps,
  ICarouselProps
} from './interface'

const CarouselContext = createContext<ICarouselContextProps | null>(null)
...
export const Carousel = forwardRef<
  HTMLDivElement,
  HTMLAttributes<HTMLDivElement> & ICarouselProps
>(
  (
    {
    ...
    const onSelect = useCallback((api: ICarouselApi) => {
      if (!api) {
        return
      }
